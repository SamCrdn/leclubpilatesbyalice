const stats = [
  { value: '+500',    label: 'cours disponibles',  href: 'https://app.leclubpilates.com/',  external: true },
  { value: '17',      label: 'catégories',          href: 'https://app.leclubpilates.com/',  external: true },
  { value: '★ 5/5',  label: 'avis Google',         href: 'https://share.google/2FofxTrt8YdrjBKRw', external: true },
