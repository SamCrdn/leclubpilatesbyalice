...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${siteUrl}/cours-de-pilates`,               lastModified: new Date('2026-04-19'), changeFrequency: 'weekly',  priority: 0.9 },
    { url: `${siteUrl}/retraite`,                       lastModified: new Date('2026-04-19'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${siteUrl}/cours-de-pilates/debutant`,      lastModified: new Date('2026-04-19'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${siteUrl}/cours-de-pilates/prenatal`,      lastModified: new Date('2026-04-19'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${siteUrl}/cours-de-pilates/dos`,           lastModified: new Date('2026-04-19'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${siteUrl}/cours-de-pilates/wall`,          lastModified: new Date('2026-04-19'), changeFrequency: 'monthly', priority: 0.9 },
    { url: `${siteUrl}/cours-de-pilates/full-body`,     lastModified: new Date('2026-04-27'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${siteUrl}/cours-de-pilates/reformer`,      lastModified: new Date('2026-04-27'), changeFrequency: 'monthly', priority: 0.8 },
